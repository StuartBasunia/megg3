...
class _BotCommands:
    def __init__(self):
        ...
        self.WatchCommand = f'watchbdx{CMD_INDEX}'
        self.ZipWatchCommand = f'zipwatchbdx{CMD_INDEX}'
        ...
        self.LeechWatchCommand = f'leechwatchbdx{CMD_INDEX}'
        self.LeechZipWatchCommand = f'leechzipwatchbdx{CMD_INDEX}'
